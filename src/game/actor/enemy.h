...
constexpr float ENEMY_BOX_X = 1.f;  
constexpr float ENEMY_BOX_W = 14.f; 
constexpr float ENEMY_BOX_H = 16.f;
...
void updateEnemies(EnemyField &ef, const Room &room, const PhysicsField &phys,
