...
const SpriteFrame HERO_ATTACK_BODY[4] = {
    {  0, 64, 16, 16 }, { 32, 64, 16, 16 },
    { 64, 64, 16, 16 }, { 96, 64, 16, 16 },
};
const SpriteFrame HERO_ATTACK_FX[4] = {
    { 16, 64, 16, 16 }, { 48, 64, 16, 16 },
    { 80, 64, 16, 16 }, {112, 64, 16, 16 },
};
...
const SpriteFrame SLIME_JUMP[15] = {
    {  0,0,16,32},{16,0,16,32},{32,0,16,32},{48,0,16,32},{64,0,16,32},
    { 80,0,16,32},{96,0,16,32},{112,0,16,32},{128,0,16,32},{144,0,16,32},
    {160,0,16,32},{176,0,16,32},{192,0,16,32},{208,0,16,32},{224,0,16,32},
};
...
const SpriteFrame SLIME_IDLE[5]  = {
    {  0,48,16,16},{16,48,16,16},{32,48,16,16},{48,48,16,16},{64,48,16,16},
};
