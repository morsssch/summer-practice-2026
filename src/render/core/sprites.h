...
const SpriteFrame SLIME_JUMP[15] = {
    ...
    {64, 0, 16, 32},  {80, 0, 16, 32},  {96, 0, 16, 32},  {112, 0, 16, 32},
    {128, 0, 16, 32}, {144, 0, 16, 32}, {160, 0, 16, 32}, {176, 0, 16, 32},
    {192, 0, 16, 32}, {208, 0, 16, 32}, {224, 0, 16, 32},
};
...
const SpriteFrame ORB_ANIM[6] = {{0, 0, 8, 8},  {8, 0, 8, 8},  {16, 0, 8, 8},
                                 {24, 0, 8, 8}, {32, 0, 8, 8}, {40, 0, 8, 8}};
...
const SpriteFrame TORCH_ANIM[12] = {
    {0, 0, 8, 24},  {8, 0, 8, 24},  {16, 0, 8, 24}, {24, 0, 8, 24},
    {32, 0, 8, 24}, {40, 0, 8, 24}, {48, 0, 8, 24}, {56, 0, 8, 24},
    {64, 0, 8, 24}, {72, 0, 8, 24}, {80, 0, 8, 24}, {88, 0, 8, 24},
};
