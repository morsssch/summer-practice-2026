...
const Room SCREEN_01 = []() {
  ...
  r.tiles[31][25] = T_STONE; // толкнуть влево на плиту
  r.tiles[19][46] = T_STONE; // на платформе середина-право
  r.tiles[26][9] = T_STONE;  // на платформе низ-лево, можно скинуть на врага
